...
initial_model = SVC(kernel='linear', C=1, random_state=42)
rfe = RFE(estimator=initial_model, n_features_to_select=10)  # Select top 10 features
train_data = rfe.fit_transform(train_data, y)
valtest_data = rfe.transform(valtest_data)
